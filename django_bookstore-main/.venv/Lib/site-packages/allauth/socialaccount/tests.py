...
class SocialAccountTests(TestCase):
    ...
    def test_email_address_created(self):
        ...
        setattr(user, account_settings.USER_MODEL_EMAIL_FIELD, "test@studentstation.me")
    ...
    def test_email_address_clash_username_required(self):
        ...
        request, resp = self._email_address_clash("test", "test@studentstation.me")
        self.assertEqual(resp["location"], reverse("socialaccount_signup"))

        # POST different username/email to social signup form
        request.method = "POST"
        request.POST = {"username": "other", "email": "other@studentstation.me"}
        resp = signup(request)
        self.assertEqual(resp["location"], "/accounts/profile/")
        user = get_user_model().objects.get(
            **{account_settings.USER_MODEL_EMAIL_FIELD: "other@studentstation.me"}
        )
    ...
    def test_email_address_clash_username_not_required(self):
        ...
        request.method = "POST"
        request.POST = {"email": "other@studentstation.me"}
        resp = signup(request)
        self.assertEqual(resp["location"], "/accounts/profile/")
        user = get_user_model().objects.get(
            **{account_settings.USER_MODEL_EMAIL_FIELD: "other@studentstation.me"}
    ...
    def test_email_address_clash_username_auto_signup(self):
        ...
        request, resp = self._email_address_clash("test", "other@studentstation.me")
        self.assertEqual(resp["location"], "/accounts/profile/")
        user = get_user_model().objects.get(
            **{account_settings.USER_MODEL_EMAIL_FIELD: "other@studentstation.me"}
        )
    ...
    def _email_address_clash(self, username, email):
        ...
        user_email(exi_user, "test@studentstation.me")
        exi_user.save()
    ...
    def test_disconnect(self):
        ...
        user_email(user, "test@studentstation.me")
        user.set_password("test")
        user.save()
    ...
    def test_verified_email_change_at_signup(self):
        ...
        sociallogin = SocialLogin(
            user=User(email="verified@studentstation.me"),
            account=SocialAccount(provider="google"),
            email_addresses=[
                EmailAddress(email="verified@studentstation.me", verified=True, primary=True)
            ],
        )
        ...
        self.assertEqual(form["email"].value(), "verified@studentstation.me")
        resp = self.client.post(
        ...
        self.assertEqual(user_email(user), "verified@studentstation.me")
        self.assertTrue(
            EmailAddress.objects.filter(
                user=user,
                email="verified@studentstation.me",
                verified=True,
                primary=True,
            ).exists()
        )
    ...
    def test_unverified_email_change_at_signup(self):
        ...
        User = get_user_model()
        sociallogin = SocialLogin(
            user=User(email="unverified@studentstation.me"),
            account=SocialAccount(provider="google"),
            email_addresses=[
                EmailAddress(
                    email="unverified@studentstation.me",
                    verified=False,
                    primary=True,
                )
            ],
        ...
        resp = self.client.get(reverse("socialaccount_signup"))
        form = resp.context["form"]
        self.assertEqual(form["email"].value(), "unverified@studentstation.me")
        resp = self.client.post(
            reverse("socialaccount_signup"),
            data={"email": "unverified@example.org"},
        )
    ...
    def test_unique_email_validation_signup(self):
        session = self.client.session
        User = get_user_model()
        User.objects.create(email="me@studentstation.me")
        sociallogin = SocialLogin(
            user=User(email="me@studentstation.me"),
            account=SocialAccount(provider="google"),
            email_addresses=[
                EmailAddress(email="me@studentstation.me", verified=True, primary=True)
            ],
        )
        session["socialaccount_sociallogin"] = sociallogin.serialize()
        session.save()
        resp = self.client.get(reverse("socialaccount_signup"))
        form = resp.context["form"]
        self.assertEqual(form["email"].value(), "me@studentstation.me")
        resp = self.client.post(
            reverse("socialaccount_signup"), data={"email": "me@studentstation.me"}
        )
    ...
    def test_social_account_taken_at_signup(self):
        ...
        User = get_user_model()
        sociallogin = SocialLogin(
            user=User(email="me1@studentstation.me"),
        ...
        resp = self.client.get(reverse("socialaccount_signup"))
        form = resp.context["form"]
        self.assertEqual(form["email"].value(), "me1@studentstation.me")
        resp = self.client.post(
            reverse("socialaccount_signup"),
            data={"username": "me1", "email": "me1@studentstation.me"},
        )
