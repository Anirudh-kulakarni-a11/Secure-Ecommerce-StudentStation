...
SOCIALACCOUNT_PROVIDERS = {"persona": {"AUDIENCE": "https://www.studentstation.me:433"}}
    ...
    def test_login(self):
        with patch(
            ...
            requests_mock.post.return_value.json.return_value = {
                "status": "okay",
                "email": "persona@studentstation.me",
            }
            ...
            get_user_model().objects.get(email="persona@studentstation.me")
